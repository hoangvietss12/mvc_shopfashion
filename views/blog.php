...
<body>
    ...
    <section class="breadcrumb-blog set-bg" data-setbg="./public/img/breadcrumb-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Tin tức</h2>
    ...
    <section class="blog spad">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="./public/img/blog/blog-4.jpg"></div>
                        <div class="blog__item__text">
                            <span><img src="./public/img/icon/calendar.png" alt=""> 16 February 2020</span>
